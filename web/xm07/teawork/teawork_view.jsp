								...
								<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
									...
									<div class="form-body">
										...
										<div class="form-group">
											...
											<div class="col-md-9">
												<input type="text" id="work_id" name="work_id" class="form-control" placeholder="请填写课程名" value="" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">
											...
											<div class="col-md-9">
												<input type="text" id="work_content" name="work_content" class="form-control" placeholder="请输入开设学院" value="" />
											</div>
										</div>
										<div class="form-group">
											<label class="col-md-3 control-label">
											...
											<div class="col-md-9">
												<input type="text" id="work_count" name="work_count" class="form-control" placeholder="请输入学分" value="" />
											</div>
										</div>
										<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/xm07/teawork/teawork_view.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
