									...
									<form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												...
												<div class="col-md-9">
													<input type="text" id="work_id" name="work_id" class="form-control" placeholder="请填写标题" value=""/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">作业内容</label>
												<div class="col-md-9">
													<input type="text" id="work_content" name="work_content" class="form-control" placeholder="请输入内容" value=""/>
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">作业人数</label>
												<div class="col-md-9">
													<input type="text" id="work_count" name="work_count" class="form-control" placeholder="请输入内容" value=""/>
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/xm07/teawork/teawork_add.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->
