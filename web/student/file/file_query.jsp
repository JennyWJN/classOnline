                            ...
                            <form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="title" name="title" class="form-control" placeholder="请填写姓名">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">班级<font color="red">*</font></label>
                                        <div class="col-md-9">
                                            <input type="text" id="status" name="status" class="form-control" placeholder="请填写班级">
                                        </div>
                                    </div>
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/student/file/student_query.js" type="text/javascript"></script>
