...
public class ServletAction extends HttpServlet {
	...
	public void exportData(JSONObject jsonObj,String filePathName) throws Exception {
		if(jsonObj!=null){
			...
			String[] cols={"index⊙text⊙ID","time_interval⊙text⊙课堂号","count⊙text⊙教师","color⊙text⊙备注","color_name⊙text⊙结课时间"};	//name⊙type⊙nick
			ew.CreExcel(jsonObj, "课堂统计", cols, filePathName);
			jsonObj.put("result_code",0);
