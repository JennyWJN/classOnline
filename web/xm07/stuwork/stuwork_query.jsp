								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">老师名（必填）<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="teacher" name="teacher" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">作业名<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="work_id" name="work_id" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">提交文件名<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="filename" name="filename" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/xm07/stuwork/stuwork_query.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->