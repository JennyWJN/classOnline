						...
						<div class="portlet box blue ">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
									<input type="hidden" id="action" name="action" value="teastu_statistic_record" />
									<input type="hidden" id="id" name="id" value="<%=id%>" />
									<input type="hidden" id="work_id" name="id" value="<%=work_id%>" />
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/xm07/statistic/teawork_statistic_query.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->