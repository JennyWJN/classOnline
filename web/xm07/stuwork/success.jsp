                        ...
                        <div class="portlet-body form">
                            <form class="form-horizontal" role="form" id="page_form" name="page_form" action="#" >
                                <div class="form-actions right1">
                                    <input type="text" id="action" name="action" value="addRecord"/>
                                    <input type="text" id="id" name="id" value="<%=id%>">
                                    <input type="text" id="work_id" name="work_id" value="<%=work_id%>">
...
<script type="text/javascript" src="../../assets/module/scripts/xm07/stuwork/stuwork_add.js"></script>
