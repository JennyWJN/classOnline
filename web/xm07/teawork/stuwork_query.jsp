							...
							<div class="portlet box blue ">
								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										<input type="hidden" id="action" name="action" value="stuList"/>
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">学生名<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="student" name="student" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/xm07/teawork/stuwork_query.js?4" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->