								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">作业名（必填）<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="work_id" name="work_id" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">作业内容<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="work_content" name="work_content" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">作业人数<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="work_count" name="work_count" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/xm07/teawork/teawork_query.js?4" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->