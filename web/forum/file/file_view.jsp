                            ...
                            <form class="form-horizontal" role="form" id="page_form" name="page_form" action="#">
                                ...
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="status" name="status" class="form-control" placeholder="请填写班级" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" id="content" name="content" class="form-control" placeholder="请输入课程名" value="" />
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-md-3 control-label">
                                        ...
                                        <div class="col-md-4">
                                            <div class="input-group date form_datetime">
                                                <input type="text" id="limit_time" name="limit_time" class="form-control" size="16" placeholder="" value="" />
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/forum/file/file_view.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
