									...
									<div class="form-body">
										<div class="form-group">
											...
											<div style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;">
												<button type="button" id="stuwork_button" class="btn green" title="查看我提交的作业">
													查看我提交的作业
												</button>
											</div>
											<div style="float: left; margin-bottom: 10px; margin-right: 10px; margin-left: 10px; margin-top: 10px;">
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/xm07/stuwork/teacher_list.js?4"></script>
<!-- END PAGE LEVEL SCRIPTS -->