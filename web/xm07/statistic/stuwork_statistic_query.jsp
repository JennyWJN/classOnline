						...
						<div class="portlet box blue ">
							...
							<div class="portlet-body form">
								<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
									<input type="hidden" id="action" name="action" value="stu_statistic_record" />
...
<!-- BEGIN PAGE SCRIPTS -->
<script type="text/javascript" src="../../assets/module/scripts/xm07/statistic/stuwork_statistic_query.js"></script>
<!-- END PAGE LEVEL SCRIPTS -->