								...
								<div class="portlet-body form">
									<form class="form-horizontal" role="form" method="post" id="page_form" name="page_form" action="#">
										...
										<div class="form-body">
											...
											<div class="form-group">
												<label class="col-md-3 control-label">课程名（必填）<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="course" name="course" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">开设学院<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="institute" name="institute" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
												<label class="col-md-3 control-label">学分<font color="red">*</font></label>
												<div class="col-md-9">
													<input type="text" id="credit" name="credit" class="form-control" placeholder="请填写名称">
												</div>
											</div>
											<div class="form-group">
...
<!-- BEGIN PAGE SCRIPTS -->
<script src="../../assets/module/scripts/subject/file/file_query.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->